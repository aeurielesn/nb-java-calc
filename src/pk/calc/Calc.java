        ...
        while (iterator.hasNext()) {
            ...
            if (token instanceof Number) {
                ...
                if (stackTop != null && stackTop instanceof Operator) {
                    ...
                    boolean test1 = (t.associativity().equals("both") || t.associativity().equals("left")) && (t.priority() <= priority);
                    //o1 jest prawostronnie ³¹czny i jego kolejnoœæ wykonywania jest mniejsza od o2,
                    boolean test2 = (t.associativity().equals("right")) && (t.priority() < priority);
                    if (test1 || test2) {
